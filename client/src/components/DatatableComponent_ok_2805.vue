    ...
    <v-container class="">
        <v-row>
            <v-col cols="12">
                ...
                <v-data-table v-model:page="page" class="elevation-1" :headers="headers" :items="items" :sort-by="sortBy" :search="search" :items-per-page="itemsPerPage" hide-default-footer multi-sort hover>
